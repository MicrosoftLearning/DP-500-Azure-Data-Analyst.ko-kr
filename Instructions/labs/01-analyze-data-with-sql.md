...
# <a name="query-files-using-a-serverless-sql-pool"></a>서버리스 SQL 풀을 사용하여 파일 쿼리
...
### <a name="use-sql-to-query-csv-files"></a>SQL을 사용하여 CSV 파일 쿼리
...
### <a name="use-sql-to-query-parquet-files"></a>SQL을 사용하여 parquet 파일 쿼리
...
### <a name="use-sql-to-query-json-files"></a>SQL을 사용하여 JSON 파일 쿼리
...
## <a name="access-external-data-in-a-database"></a>데이터베이스의 외부 데이터 액세스
...
## <a name="visualize-query-results"></a>쿼리 결과 시각화
