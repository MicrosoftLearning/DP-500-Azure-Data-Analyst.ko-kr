...
8. **데이터 허브** 창에서 **판매 분석 - 재사용 가능한 Power BI 아티팩트 만들기** 데이터 세트를 선택합니다.

    ![](../images/dp500-create-reusable-power-bi-artifacts-image18.png)

9. **연결**을 선택합니다.

10. **데이터 연결** 대화 상자에서 **판매 분석 - 재사용 가능한 Power BI 아티팩트 만들기** 옆 의 확인란을 선택한 다음 **제출**을 선택하여 데이터 원본에 연결합니다.
...
3. **데이터 연결** 대화 상자에서 **판매 분석 - 재사용 가능한 Power BI 아티팩트 만들기** 옆 의 확인란을 선택했음을 확인한 다음 **제출**을 선택하여 데이터 원본 스토리지 모드로 변경합니다.
...
2. **데이터** 창(오른쪽에 있음)에서 **재판매인** 테이블을 확장하여 엽니다.
...
8. **데이터** 창의 **재판매인** 테이블 내부에서 **시-도** 필드를 끌어 테이블 시각적 개체에 가져다 놓습니다.

    ![](../images/dp500-create-reusable-power-bi-artifacts-image32.png)

9. **데이터** 창에서 **매출** 테이블을 확장한 다음, 테이블 시각적 개체에 **매출 금액** 필드를 추가합니다.

    ![](../images/dp500-create-reusable-power-bi-artifacts-image33.png)

10. 판매 금액의 내림차순으로 상태를 정렬하려면 **매출 금액 합계** 머리글을 선택합니다.
...
2. **데이터** 창에서 **매출** 테이블을 마우스 오른쪽 단추로 클릭한 다음 **새 측정값**을 선택합니다.
...
5. 행렬 시각적 개체에 측정값을 추가하려면 **데이터** 창의 **매출** 테이블 내에서 **1인당 매출** 필드를 테이블 시각적 개체로 끌어옵니다.
