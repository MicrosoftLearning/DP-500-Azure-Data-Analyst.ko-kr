...
1. **D:\DP500\Allfiles\05\Starter** 폴더로 이동하세요.
...
1. **데이터** 창에서 **Date** 테이블을 확장한 다음 **Month Offset** 필터 필드를 가로 막대형 차트 시각적 개체로 끌어옵니다.
...
1. 월 오프셋 필터 값이 시간순으로 정렬되도록 하려면 **데이터** 창에서 **월 오프셋 필터** 필드를 선택하세요.
