...
3. Power BI Desktop 오른쪽 위 모서리에서 아직 로그인하지 않은 경우 **로그인**을 선택합니다. 랩 자격 증명을 사용하여 로그인 프로세스를 완료합니다.
...
1. **Synapse Studio** 왼쪽에서 **개발** 허브를 선택합니다.
...
33. **DimProductSubcategory.ProductSubcategoryKey** 열의 이름을 **ProductSubcategoryKey** 및 **DimProductSubcategory.EnglishProductSubcategoryName**으로 **이름을 EnglishProductSubcategoryName**으로 바꿉니다.
